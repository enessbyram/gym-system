  ...
  return (
    <div className="bg-[#161515] w-full h-auto py-10 md:py-20 flex flex-col items-center font-montserrat">
      ...
      <div className="container px-4 flex flex-col md:flex-row flex-wrap gap-8 justify-center items-start">
        ...
        <div className="relative group w-full md:w-[45%] bg-[#1e1e1e] rounded-2xl border border-[#333] overflow-hidden transition-all duration-500 hover:border-[#7c3aed] hover:shadow-[0_0_40px_rgba(124,58,237,0.4)]">
          
          <div className="h-24 md:h-32 flex items-center px-6 relative z-10">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-[#7c3aed]/20 rounded-xl flex items-center justify-center mr-5 shrink-0 transition-transform duration-500 group-hover:scale-110">
              <FontAwesomeIcon
                icon={faDumbbell}
                className="text-2xl md:text-3xl text-[#7c3aed] rotate-135"
              />
            </div>
            ...
            <div className="flex flex-col gap-3 pt-2">
              ...
              {gymPackages.length > 0 ? (
                gymPackages.map((pkg) => (
                  <div 
                    key={pkg.id} 
                    className="flex justify-between items-center p-3 md:p-4 rounded-xl bg-[#252525] border border-[#333] hover:border-[#7c3aed] transition-colors cursor-pointer group/item"
                  >
                    ...
                    <span className="text-[#7c3aed] font-bold text-base md:text-lg">
          ...
          <div className="absolute right-12 top-0 h-full w-40 bg-[#7c3aed] rounded-full blur-[60px] opacity-20 pointer-events-none transition-all duration-500 group-hover:opacity-20"></div>
        </div>
      ...
      <div className="w-full mt-10 md:mt-16 flex justify-center items-center px-4">
        <Link 
          to="/packages" 
          className="bg-[#7c3aed] cursor-pointer text-white px-6 py-3 rounded-lg hover:bg-[#6d28d9] transition duration-300 shadow-[0_0_20px_rgba(124,58,237,0.7)] hover:shadow-[0_0_30px_rgba(124,58,237,0.9)] flex items-center justify-center text-base md:text-lg w-full md:w-auto"
        >
