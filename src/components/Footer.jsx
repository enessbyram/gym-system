    ...
    <footer className="w-full h-auto bg-black flex items-center justify-center flex-col py-10 font-montserrat">
      <div className="container px-4 flex flex-col md:flex-row justify-between w-full gap-10 md:gap-0">
        ...
        <div className="flex flex-col w-full md:w-5/12 gap-4">
          {/* GÜNCELLENDİ: Başlık Rengi Mor */}
          <h4 className="text-[#7c3aed] text-xl font-bold">İletişim</h4>
          <div className="flex flex-row items-start gap-3 text-sm">
            {/* GÜNCELLENDİ: İkon Rengi Mor */}
            <FontAwesomeIcon icon={faLocation} color="#7c3aed" className="mt-1" />
          ...
          <div className="flex flex-row items-center gap-3 text-sm">
            {/* GÜNCELLENDİ: İkon Rengi Mor */}
            <FontAwesomeIcon icon={faPhone} color="#7c3aed" />
            <p className="text-[#888]">+90 216 123 45 67</p>
          </div>
          <div className="flex flex-row items-center gap-3 text-sm">
            {/* GÜNCELLENDİ: İkon Rengi Mor */}
            <FontAwesomeIcon icon={faBox} color="#7c3aed" />
            <p className="text-[#888]">lumexconsulting</p>
          </div>
        </div>

        <div className="flex flex-col w-full md:w-5/12">
          {/* GÜNCELLENDİ: Başlık Rengi Mor */}
          <h4 className="text-[#7c3aed] text-xl font-bold mb-4">Çalışma Saatleri</h4>
          ...
          {/* GÜNCELLENDİ: Başlık Rengi Mor */}
          <h4 className="text-[#7c3aed] text-xl font-bold mb-3">Hakkımızda</h4>
          <p className="text-[#888] text-sm leading-relaxed">
            {/* GÜNCELLENDİ: Marka İsmi ve Renkler */}
            <span className="text-[#7c3aed] font-semibold">Lumex</span>
            <span className="text-white mx-1">Consulting</span>,
